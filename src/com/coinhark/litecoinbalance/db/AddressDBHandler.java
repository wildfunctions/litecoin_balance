...
public class AddressDBHandler {
  ...
  private String[] allColumns = {
		  MySQLiteHelper.ADDRESSES_COLUMN_ID,
		  MySQLiteHelper.ADDRESSES_COLUMN_NAME, 
		  MySQLiteHelper.ADDRESSES_COLUMN_ADDRESS
  };
  ...
  public Address createAddress(String name, String address) {
    ...
    values.put(MySQLiteHelper.ADDRESSES_COLUMN_NAME, name);
    values.put(MySQLiteHelper.ADDRESSES_COLUMN_ADDRESS, address);
    ...
    Cursor cursor = database.query(MySQLiteHelper.TABLE_ADDRESSES,
        allColumns, MySQLiteHelper.ADDRESSES_COLUMN_ID + " = " + insertId, null,
        null, null, null);
    cursor.moveToFirst();
  ...
  public void deleteAll() {
	  ...
	  database.delete(MySQLiteHelper.TABLE_ADDRESSES, MySQLiteHelper.ADDRESSES_COLUMN_ID + " > 0 ", null);
  }
  
  public void deleteAddress(Address address) {
    long id = address.getId();
    Log.d("[Litecoin Balance]", "Address deleted with id: " + id);
    database.delete(MySQLiteHelper.TABLE_ADDRESSES, MySQLiteHelper.ADDRESSES_COLUMN_ID
        + " = " + id, null);
  }
